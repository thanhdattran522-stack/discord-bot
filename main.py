...
async def check(ctx, username: str):
    try:
        ...
        avatar_url = thumb['data'][0]['imageUrl'] if 'data' in thumb else None
        ...
        bad_found = [f"🛑 **{g['group']['name']}** ({g['group']['id']})" for g in groups.get('data', []) if g['group']['id'] in DANH_SACH_DEN]
